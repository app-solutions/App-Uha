//
//  LaSemaineProchaineViewController.m
//  App Uha
//
...
#import "LaSemaineProchaineViewController.h"
#import "PlanningCell.h"
#import "JsonReader.h"
#import "Cours.h"

@interface LaSemaineProchaineViewController ()

@end

@implementation LaSemaineProchaineViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSMutableArray *coursLundi = [jr getCoursForWeek:@"semaine2" andDay:@"lundi"];
    NSMutableArray *coursMardi = [jr getCoursForWeek:@"semaine2" andDay:@"mardi"];
    NSMutableArray *coursMercredi = [jr getCoursForWeek:@"semaine2" andDay:@"mercredi"];
    NSMutableArray *coursJeudi = [jr getCoursForWeek:@"semaine2" andDay:@"jeudi"];
    NSMutableArray *coursVendredi = [jr getCoursForWeek:@"semaine2" andDay:@"vendredi"];
    NSMutableArray *coursSamedi = [jr getCoursForWeek:@"semaine2" andDay:@"samedi"];
    ...
    lundiName = [jr getDayNameForWeek:@"semaine2" andDay:@"lundi"];
    mardiName = [jr getDayNameForWeek:@"semaine2" andDay:@"mardi"];
    mercrediName = [jr getDayNameForWeek:@"semaine2" andDay:@"mercredi"];
    jeudiName = [jr getDayNameForWeek:@"semaine2" andDay:@"jeudi"];
    vendrediName = [jr getDayNameForWeek:@"semaine2" andDay:@"vendredi"];
    samediName = [jr getDayNameForWeek:@"semaine2" andDay:@"samedi"];
