...
#import "Dans3SemainesViewController.h"
#import "PlanningCell.h"
#import "JsonReader.h"
#import "Cours.h"

@interface Dans3SemainesViewController ()

@end

@implementation Dans3SemainesViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSMutableArray *coursLundi = [jr getCoursForWeek:@"semaine4" andDay:@"lundi"];
    NSMutableArray *coursMardi = [jr getCoursForWeek:@"semaine4" andDay:@"mardi"];
    NSMutableArray *coursMercredi = [jr getCoursForWeek:@"semaine4" andDay:@"mercredi"];
    NSMutableArray *coursJeudi = [jr getCoursForWeek:@"semaine4" andDay:@"jeudi"];
    NSMutableArray *coursVendredi = [jr getCoursForWeek:@"semaine4" andDay:@"vendredi"];
    NSMutableArray *coursSamedi = [jr getCoursForWeek:@"semaine4" andDay:@"samedi"];
    ...
    lundiName = [jr getDayNameForWeek:@"semaine4" andDay:@"lundi"];
    mardiName = [jr getDayNameForWeek:@"semaine4" andDay:@"mardi"];
    mercrediName = [jr getDayNameForWeek:@"semaine4" andDay:@"mercredi"];
    jeudiName = [jr getDayNameForWeek:@"semaine4" andDay:@"jeudi"];
    vendrediName = [jr getDayNameForWeek:@"semaine4" andDay:@"vendredi"];
    samediName = [jr getDayNameForWeek:@"semaine4" andDay:@"samedi"];
