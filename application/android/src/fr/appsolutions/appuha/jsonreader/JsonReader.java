...
public class JsonReader {
	...
	public ArrayList<Cours> getAllWeeknDaysCours() throws JSONException{
		...
		for(int i=0; i<4; i++){
			...
			JSONArray jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(LUNDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}

			jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(MARDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}

			jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(MERCREDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}

			jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(JEUDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}

			jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(VENDREDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}

			jsra = new JSONArray( (String) appUha.getJSONObject("semaines").getJSONObject(semaine).getJSONObject("jours").getJSONObject(SAMEDI).getString("cours") );		
			for(int o=0; o<jsra.length(); o++){
				JSONObject j = jsra.getJSONObject(o);
				ar.add(new Cours( (String) j.getString("id"), (String) j.getString("start"), (String) j.getString("stop"), (String) j.getString("durée"), (String) j.getString("nom"), (String) j.getString("salle"), (String) j.getString("enseignant")));
			}
