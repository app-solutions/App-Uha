...
public class JsonReader
{
	...
	public ArrayList<Cours> getDayCours(String jour)
		...
		for (int i = 0; i < jsra.length(); i++) {
			...
			ar.add(new Cours(j.getString("id"), j.getString("jour") ,j.getString("start"), j.getString("stop"), "non ajouté", j.getString("durée"), j.getString("nom"), j.getString("salle"), j.getString("enseignant")));
		}
